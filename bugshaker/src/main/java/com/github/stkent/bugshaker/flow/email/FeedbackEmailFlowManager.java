					...
					screenshotProvider.getScreenshotUri(activity)
						...
						.subscribe(new Subscriber<Uri>() {
							...
							public void onNext(final Uri uri) {
								...
								Set<String> emailAddresses = SharedPreferencesUtil.getEmailAddresses(activity);
								String[] emailAddressesArray = emailAddresses.toArray(new String[emailAddresses.size()]);
